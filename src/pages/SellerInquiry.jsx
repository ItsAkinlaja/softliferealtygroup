...
import { CheckCircle, DollarSign, Clock, Megaphone, Users } from 'lucide-react';
        ...
        <div className="relative z-20 container-custom px-4 flex flex-col items-center">
          ...
          <FadeIn>
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-4 tracking-tight drop-shadow-2xl">
              Maximize Your <span className="text-gold italic">Property Value</span>
            </h1>
            <div className="h-1 w-24 bg-gold mx-auto mb-6"></div>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed">
              Let us guide you through your home selling journey with expert strategies and maximum returns.
            </p>
          </FadeIn>
        </div>
      </section>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-8">
                    ...
                    to help you sell your property for maximum value and with minimal hassle.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-charcoal mb-2">Maximum Value</h3>
                      <p className="text-gray-600 text-sm">Strategic pricing to get the best market value.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-charcoal mb-2">Quick Sale</h3>
                      <p className="text-gray-600 text-sm">Efficient marketing and negotiation for fast closings.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-charcoal mb-2">Expert Marketing</h3>
                      <p className="text-gray-600 text-sm">Professional photography and targeted advertising.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-charcoal mb-2">Full Support</h3>
                      <p className="text-gray-600 text-sm">Complete assistance from listing to closing.</p>
                    </div>
                  </div>
                </div>
            ...
            <FadeIn delay={0.2}>
              <div className="bg-white p-8 rounded-lg shadow-2xl border border-gray-100">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-serif font-bold text-charcoal mb-3">Start Your Sale</h3>
                  <p className="text-gray-600">
                    Fill out the form below and we'll get back to you within 24 hours with a personalized selling strategy.
                  </p>
                </div>
