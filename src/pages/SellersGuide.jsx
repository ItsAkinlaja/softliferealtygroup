       ...
       <section className="py-20">
        ...
        <section className="bg-charcoal text-white py-20 relative overflow-hidden">
             ...
             <div className="container-custom px-4 text-center relative z-10">
               <FadeIn>
                   <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Curious about your home's current value?</h2>
                   <p className="text-white/70 mb-8 max-w-2xl mx-auto font-light">Get a complimentary, professional valuation from our experts.</p>
